...
public enum MaterialType {
    ...
    CLIMBABLE("WEEPING_VINES", "TWISTING_VINES", "LADDER", "VINE", "WEEPING_VINES_PLANT",
            "TWISTING_VINES_PLANT", "CAVE_VINES", "CAVE_VINES_PLANT", "SCAFFOLDING"),
    ...
    MaterialType(final String... values) {
        this.values = values;
    }

    public static boolean isMaterial(final String value, final MaterialType type) {
